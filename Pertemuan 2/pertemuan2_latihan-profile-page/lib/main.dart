...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // body: Center(
        // child: Text('Body akan diisi di Langkah 4'),
          // child: Row(
          //   children: [
          //     Container(width: 80, height: 80, color: Colors.red), // fixed 80px
          //     Flexible(child: Container(height: 80, color: Colors.green)), // sisa ruang
      ...
      // Contoh code menggunakan SingleChildScrollView
      // body: SingleChildScrollView(
      //   child: Column(
      //     children: [
      //       Container(height: 300, color: Colors.red, child: const Center(child: Text('Kotak Merah'))),
      //       Container(height: 300, color: Colors.green, child: const Center(child: Text('Kotak Hijau'))),
      //       Container(height: 300, color: Colors.blue, child: const Center(child: Text('Kotak Biru'))),
      //     ],
      //   ),
      // ),

      // Contoh code menggunakan ListView
      // body: ListView(
      //   children: const [
      //     ListTile(leading: Icon(Icons.star), title: Text('Item Bintang')),
      //     ListTile(leading: Icon(Icons.favorite), title: Text('Item Favorit')),
      //     ListTile(leading: Icon(Icons.person), title: Text('Item Profil')),
      //     ListTile(leading: Icon(Icons.settings), title: Text('Item Pengaturan')),
      //     ListTile(leading: Icon(Icons.message), title: Text('Item Pesan')),
      //   ],
      // ),

      //Contoh code menggunakan ListView.Builder
      // body: ListView.builder(
      //   itemCount: 30,
      //   itemBuilder: (context, index) {
      //     return ListTile(
      //       leading: CircleAvatar(child: Text('${index + 1}')),
      //       title: Text('Ini adalah Data ke-${index + 1}'),
      //     );
      //   },
      // ),
...
class CategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final body = switch (name) {
      ...
      _ => const Center(child: Text('Belum Dibuat')),
    };
